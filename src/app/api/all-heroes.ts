...
export const HeroesData: Hero[] = [
    ...
    {
        id: 5,
        avatar: 'assets/images/heroes/5-thumbnail.jpg',
        name: 'Iron man',
        alterEgo: 'Tony Stark',
    ...
    {
        id: 6,
        avatar: 'assets/images/heroes/6-thumbnail.jpg',
        name: 'Captain America',
        alterEgo: 'Steven Grant Rogers',
        synopsis: 'Captain America is a fictional superhero appearing in American comic books published by Marvel Comics. Created by cartoonists Joe Simon and Jack Kirby, the character first appeared in Captain America Comics #1 (cover dated March 1941) from Timely Comics, a predecessor of Marvel Comics. Captain America was designed as a patriotic supersoldier who often fought the Axis powers of World War II and was Timely Comics\' most popular character during the wartime period. The popularity of superheroes waned following the war and the Captain America comic book was discontinued in 1950, with a short-lived revival in 1953. Since Marvel Comics revived the character in 1964, Captain America has remained in publication.',
        likes: 1500
    },
    {
        id: 7,
        avatar: 'assets/images/heroes/7-thumbnail.jpg',
        name: 'Hulk',
    ...
    {
        id: 8,
        avatar: 'assets/images/heroes/8-thumbnail.jpg',
        name: 'Deadpool',
